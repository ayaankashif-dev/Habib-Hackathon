...
export const translations: Record<Lang, Dict> = {
  en: {
    ...
    guardianSubtitle: "They received this message and asked for your advice. Please check and verify.",
    receivedMessageLabel: "Message Received",
    guardianAnalysisLabel: "ScamWatch Detection",
  ...
  ur: {
    ...
    guardianSubtitle: "انہیں یہ پیغام موصول ہوا ہے اور انہوں نے آپ سے مشورہ مانگا ہے۔ براہ کرم چیک کر کے بتائیں۔",
    receivedMessageLabel: "یہ پیغام آیا تھا",
    guardianAnalysisLabel: "اسکیم واچ کا تجزیہ",
  ...
  "roman-ur": {
    ...
    guardianSubtitle: "Unhe yeh message aaya hai aur unhone aap se mashwara maanga hai. Check karke batayein.",
    receivedMessageLabel: "Yeh Message Aaya Tha",
    guardianAnalysisLabel: "ScamWatch Analysis",
